class UnpaidWork::API
    ...
    #     men_unpaid = dataset["dataSets"][0]["observations"]
    #     women_unpaid = dataset["dataSets"][0]["observations"]
    #     men_paid = dataset["dataSets"][0]["observations"]
    #     women_paid = dataset["dataSets"][0]["observations"]
    #     men_total = dataset["dataSets"][0]["observations"]
    #     women_total = dataset["dataSets"][0]["observations"]
